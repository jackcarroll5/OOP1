 ...
 *another method to check if the customer's credit limit is exceeded*/
 ...
 public class Exercise2Lab6OOP1 {
   public static void main(String args[])
   {
   	  String accountNum;
   	  float balance, debits, credits, creditLimit;
   	
     accountNum = getCustomerAccountNumber();	
   	...
   	displayResults(accountNum, balance, debits, credits, creditLimit);
  ...
  JOptionPane.showMessageDialog(null,"Thanks for using the system - goodbye!",
   ...
   public static boolean checkCreditLimit(float balance, float debits,
    ...
    if(newBalance < -creditLimit)
     ...
     public static void displayResults(String accountNum, float balance, float debits,
     float credits, float creditLimit)
     	{
